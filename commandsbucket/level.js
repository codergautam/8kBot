...
const Discord = require("discord.js");
        ...
        module.exports = {
            ...
            name: 'level',
            aliases: ["level", "xp", "xpcard", "rankcard"],
            secret: false,
            category: "other",
            format: "",
            usage: [""],
            description: "This command shows a rank card showing your xp, rank, level, and how much more xp needed to advance to the next level!\nYou can gain more xp by being active in servers that have 8k bot!", 
