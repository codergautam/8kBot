    ...
    async(message, args, client, addCD) => {
        ...
        api.getUser(user1.id).then((user1)=>{
            api.getUser(user2.id).then((user2)=>{
                ...
                var subsToGive = Math.floor(user1.youtube.subs < 10000 ? getRandomInt(user1.youtube.subs/100, user1.youtube.subs/10) : getRandomInt(user1.youtube.subs/1000, user1.youtube.subs/100))
